...
if(userName.lower() == "skyler" and userPassword == "fakePassword"):
...
#provided to it, and make it all lowercase. So, if I were to run the command HELLO.lower() the output
#would be `hello` in all lowercase characters
